...
namespace Trekster_web.Controllers
{
    ...
    public class ExpensesController : Controller
    {
        ...
        public ExpensesController(ICurrencyService currencyService,
        ...
        public IActionResult Index()
        {
            ...
            expencesVM.Summary = GetSummary();
            expencesVM.ExpencesByCategory = GetExpencesByCategory();
        ...
        private List<string> GetExpencesByCategory()
        {
